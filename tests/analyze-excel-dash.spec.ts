...
import { ALL_ANALYZE_ROUTES, ALL_DASH_ROUTES, ALL_DATAHUB_ROUTES, ALL_EXCEL_DOC_ROUTES, ALL_REPORTS_ROUTES } from './routes/common.routes';
...
ALL_USERS.forEach((user) => {
  test.describe(`Testing for user role: ${user.role}`, () => {
    ...
    test('All Analyze, Excel and Dash Routes', async ({}) => {
      await setupApiMocks(page, user.role);

      let allRoutes = [
        ...ALL_ANALYZE_ROUTES,
        ...ALL_EXCEL_DOC_ROUTES,
        ...ALL_DASH_ROUTES,
      ];
