...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.winnow_results = function() {
      ...
      filteredQuery = query.replace(/<[^>]+>/g, "");
      if(query != filteredQuery){
        this.set_search_field_value(filteredQuery);
        query = filteredQuery;
      }
  ...
  Chosen = (function(superClass) {
    ...
    Chosen.prototype.set_search_field_value = function(value) {
      return this.search_field.val(value);
    };

    Chosen.prototype.get_search_text = function() {
      var searchText = $.trim(this.get_search_field_value());
      return searchText;
    };
