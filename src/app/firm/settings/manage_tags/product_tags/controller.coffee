class FirmSettingsProductTagsController extends BaseController
    @register 'FirmSettingsProductTagsController'
    ...
    removeStrategy: (strategy, index)->
        ...
        @Restangular.all('strategies').customPUT(params).then =>
            @toaster.pop 'success', 'Custom classification removed successfully!'
