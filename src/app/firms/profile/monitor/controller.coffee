class FirmProfileMonitorController extends BaseController

  @register 'FirmProfileMonitorController'

  @inject '$stateParams', 'Restangular', 'previousState', '$q', '$state', '$scope', '$filter', 'toaster',
    'SweetAlert', 'Utils', 'BaseDataService', 'ModalFactory', '$anchorScroll', '$location', 'MentionsFactory',
