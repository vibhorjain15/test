class FundDDQsController extends BaseController
  @register 'FundDDQsController'
  ...
  redirectToQuestionnaire: (ddq)=>
    ...
    if ddq.entity_type.toLowerCase() == @keywordConstants.Product.toLowerCase()             #if diligence type is fund then go to firms.funds route
