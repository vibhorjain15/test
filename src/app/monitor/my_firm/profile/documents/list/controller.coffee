class MyFirmDocumentsListController extends BaseController

  @register 'MyFirmDocumentsListController'

  @inject 'FirmDataservice', '$stateParams', '$scope', '$state', 'DocumentListResource',
          'Restangular', 'toaster', 'SweetAlert', 'Utils', 'ModalFactory', 'DocumentsService', '$rootScope','DocumentDataservice', 'entityTypeValue'

  initialize: ->
    @entity_id = @Utils.getCurrentFirm().id
